...
Plot in de tijd, alle simulaties op 1 grafiek: gebruikt voor presentatie REDCO april
...
for i in range(len(MC_all)):
    if design_grid['MRC_WIND_BARRIER'][i]==2 or design_grid['MEW_WIND_BARRIER'][i]==80:
        plot(MC_allkgkg[i], lw=0.5, color=tableau20[15], label='1')
    else:
        plot(MC_allkgkg[i], lw=0.5, color=tableau20[15], label='1')
        
        
#plot(MC_allkgkg[1], lw=2, color=tableau20[6], label='1')        
...
savefig('C:/Users/jelle/Desktop/ALLES.png', bbox_inches="tight")
...
text(2000,0.41, "MOISTURE CONTENT (KG/KG) @ SURFACE ", fontsize=17, ha="left") 
savefig('C:/Users/jelle/Desktop/ALLES1.png', bbox_inches="tight")
