...
%t
filerv='C:\PostDoc\SIMULATIES\IMPACT CLADDING\SIDINGS VLIET\VLIET\WAND3_NE.results\T_surf.out';
fid = fopen(filerv, 'rt');
a = textscan(fid, '%f %f','Delimiter',',', 'CollectOutput',0, 'HeaderLines',13);  
t_sim=cell2mat(a(:,2));

filerv='C:\PostDoc\SIMULATIES\IMPACT CLADDING\SIDINGS VLIET\VLIET\WAND3_NE_zon1.results\T_surf.out';
fid = fopen(filerv, 'rt');
a = textscan(fid, '%f %f','Delimiter',',', 'CollectOutput',0, 'HeaderLines',13);  
t_sim1=cell2mat(a(:,2));

filerv='C:\PostDoc\SIMULATIES\IMPACT CLADDING\SIDINGS VLIET\VLIET\WAND3_NE_zon2.results\T_surf.out';
fid = fopen(filerv, 'rt');
a = textscan(fid, '%f %f','Delimiter',',', 'CollectOutput',0, 'HeaderLines',13);  
t_sim2=cell2mat(a(:,2));

filerv='C:\PostDoc\SIMULATIES\IMPACT CLADDING\SIDINGS VLIET\VLIET\WAND3_NE_zon3.results\T_surf.out';
fid = fopen(filerv, 'rt');
a = textscan(fid, '%f %f','Delimiter',',', 'CollectOutput',0, 'HeaderLines',13);  
t_sim3=cell2mat(a(:,2));
...
tijd_meas=aver_matrix(W3A3MTC(s_t:e_t,1),6);
t_3_meas=aver_matrix(W3A3MTC(s_t:e_t,:),6);
t_2_meas=aver_matrix(W3A2MTC(s_t:e_t,:),6);
t_4_meas=aver_matrix(W3A4MTC(s_t:e_t,:),6);
t_5_meas=aver_matrix(W3A5MTC(s_t:e_t,:),6);
